...
fun main() {
    ...
    val geoLocationService = GeoLocationService(commonHttpClient, userAgent)
    ...
    val appFlow = AppFlow(deepSpaceNetworkService, flightService, geoLocationService, spaceWeatherService, weatherService)
